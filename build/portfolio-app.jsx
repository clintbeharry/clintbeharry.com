            ...
            <div className="about-grid">
              <div className="about-body">
                <ul className="about-list">
                  ...
                  <li>I craft unifying strategies backed by a computer engineering background and research with social scientists on how technology changes behavior. Backed up by fifteen years building businesses across web, mobile, XR and now AI.</li>
