...
window.PROJECTS = [
  ...
  },
  {
    ...
    impact: "It launched at Google I/O and was covered by CNET, Fast Company, and The Verge. Once real users got in, they spent most of their time in the immersive video and the 3D stock visualization, the two things only VR could do, and the least time reading articles, confirming VR's value wasn't replicating what 2D screens already do well. **The spatial design system I built to get there outlived the platform itself, it's still the foundation for WSJ's spatial content and software today.**",
  },
];
